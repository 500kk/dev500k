        ...
        <div id="user-profile">
          ...
          <div id="profile-info">
            <Row>
              ...
              <Col lg="6" md="12">
              {inv.map((elem) => (
                    <Posts2 investName ={elem.investName} price={elem.price} date={elem.created} comments={elem.comments} companyName={elem.userId.companyName} pic={elem.userId.pic} picInv={elem.pic} desc={elem.desc}/>))}
              </Col>
            </Row>
            <Row>
