...
const buildFolder = lazy(() => import("./views/pages/buildFolder/buildFolder"))
const ansFolder = lazy(() => import("./views/pages/ansFolder/ansFolder"))
    ...
    return (
      ...
      <Router history={history}>
        <Switch>
          ...
          <AppRoute path="/pages/buildFolder" component={buildFolder} />
          <AppRoute path="/pages/ansFolder" component={ansFolder} />
